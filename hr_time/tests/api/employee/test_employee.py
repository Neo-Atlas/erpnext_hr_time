...
class TestEmployee(unittest.TestCase):
    def test_is_minor_true(self):
        employee = Employee("test", TimeModel.Undefined, "", datetime.date(2000, 1, 15), datetime.date.today())
    ...
    def test_is_minor_true_leap_year(self):
        employee = Employee("test", TimeModel.Undefined, "", datetime.date(2004, 2, 29), datetime.date.today())
        today = datetime.date(2018, 1, 10)
